...
]  as const).filter(x => x.AtomicNumber <= 98).map(x => ({ ...x, OxidationStates: x.GroupBlock === "Alkali metal" ? [1] : x.GroupBlock === "Alkaline earth metal" ? [2] : x.GroupBlock === "Halogen" ? [-1] : x.OxidationStates }))